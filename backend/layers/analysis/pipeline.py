...
class AnalysisPipeline:
    def __init__(
        ...
        *,
        ...
        from backend.layers.analysis.impact_analyzer import ImpactAnalyzer
        from backend.layers.analysis.maturity_analyzer import MaturityAnalyzer
        from backend.layers.analysis.quality_analyzer import QualityAnalyzer
        from backend.layers.analysis.technology_radar import TechnologyRadarAnalyzer
