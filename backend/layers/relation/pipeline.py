...
class RelationPipeline:
    def __init__(self, *, linkers: list[Any] | None = None) -> None:
        from backend.layers.relation.adopt_linker import AdoptLinker
        from backend.layers.relation.compare_linker import CompareLinker
        from backend.layers.relation.discuss_linker import DiscussLinker
        from backend.layers.relation.implement_linker import ImplementLinker
        from backend.layers.relation.mention_linker import MentionLinker
        from backend.layers.relation.propose_linker import ProposeLinker
