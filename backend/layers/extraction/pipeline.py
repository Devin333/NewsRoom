...
from backend.foundation import AnalysisContext, Claim, Entity, Signal, Technology, Topic
...
from backend.layers.extraction.models import ExtractionResult, ExtractionWarning, TaxonomyAssignment
from backend.layers.extraction.taxonomy_classifier import TaxonomyClassifier
