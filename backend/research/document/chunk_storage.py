...
from backend.research.ports.chunk_payload_store import (
    ChunkPayloadRepositoryPort,
    ChunkPayloadStorePort,
)
from backend.research.services.tenant_visibility import payload_visible_to_tenant, strip_tenant_filters
