...
from backend.research.document.citation_spans import resolve_citation_span
from backend.research.document.models import PaperChunk
from backend.research.rag.adapters.paper_chunk_adapter import paper_chunk_to_rag_evidence
from backend.research.rag.retrieval.paper_claim_index import extract_claim_records
from backend.research.rag.retrieval.contracts import RetrievalRequest
