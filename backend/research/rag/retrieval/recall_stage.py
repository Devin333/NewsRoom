...
from backend.research.ports.field_embedding_index import FieldEmbeddingHit
...
from backend.research.rag.retrieval.channels.sparse_lexical import SparseLexicalChannel, sparse_query_tokens
from backend.research.rag.retrieval.channels.visual import VisualRecallChannel
from backend.research.rag.retrieval.fusion import fuse_chunk_rankings
from backend.research.rag.retrieval.filtering import filter_scored_chunks_for_request
from backend.research.rag.retrieval.paper_claim_index import ClaimSearchHit
from backend.research.rag.retrieval.scoring import claim_from_citation_question
from backend.research.rag.retrieval.trace import RetrievalTrace
