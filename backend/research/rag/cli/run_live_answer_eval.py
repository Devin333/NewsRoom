...
from backend.research.rag.evaluation.ci_eval_gate import (
    DEFAULT_RETRIEVAL_POLICY,
    parse_thresholds,
)
from backend.research.rag.evaluation.live_answer_eval import (
    DEFAULT_OUTPUT_DIR,
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m backend.research.rag.cli.run_live_answer_eval",
