...
from backend.research.domain import GateResult, ResearchReaderPayload
...
from backend.research.reader.gates import validate_reader_navigation, validate_reader_payload_schema, validate_reader_source_lineage
