...
export function SummaryCard({ label, value, compact = false }: { label: string; value: string | number; compact?: boolean }) {
  return (
    <div
      ...
      className={cn("rounded-2xl bg-[#edf1ee] p-4 dark:bg-secondary", compact && "flex min-h-[5.25rem] flex-col items-center justify-center text-center", !compact && "border border-border bg-background/60")}
    >
