          ...
          <DetailPanel title="Representative comments">
            {topic.representativeComments.length ? (
              ...
              <p className="text-sm leading-6 text-muted-foreground">
                No public representative comment excerpts were included in this artifact.
              </p>
            )}
          </DetailPanel>

          <DetailPanel title="Evidence refs">
            {topic.evidenceRefs?.length ? (
              ...
              <p className="text-sm text-muted-foreground">No public evidence refs are available.</p>
            )}
          </DetailPanel>
        </div>
  ...
  return (
    <article className="border-b border-border pb-4 last:border-b-0 last:pb-0">
      ...
      <div className="mt-2 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
        ...
        {discussion.upvoteCount !== undefined ? <span>{discussion.upvoteCount} votes</span> : null}
        {discussion.url ? (
  ...
  return (
    <div className="mb-4 last:mb-0">
      ...
      {items.length ? (
        ...
        <p className="text-sm text-muted-foreground">No public links.</p>
      )}
    </div>
  )
}
