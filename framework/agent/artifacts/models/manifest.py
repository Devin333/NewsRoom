...
from framework.agent.artifacts.models.reference import ArtifactReference
...
class ArtifactManifest:
    ...
    schema_version: str = "framework.agent.artifacts.manifest.v1"
    ...
    def from_dict(cls, payload: dict[str, Any]) -> "ArtifactManifest":
        return cls(
            ...
            schema_version=str(payload.get("schema_version") or "framework.agent.artifacts.manifest.v1"),
