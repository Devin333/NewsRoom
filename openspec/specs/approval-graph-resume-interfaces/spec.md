# approval-graph-resume-interfaces Specification

## Purpose
Define versioned application, HTTP, CLI, MCP, and SDK surfaces for submitting approval causes to a durable Graph Wait.
