...
- [x] 4.1 Inject the request preparer into `LLMRouter` and run profile resolution, normalization, count, and admission for every enabled capability-compatible deployment before provider/global-budget admission.
