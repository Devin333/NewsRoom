...
def _decision_from_payload(
    ...
    *,
    ...
    return DecisionMemory(
        ...
        graph_id=_optional_text(payload.get("graph_id")),
        graph_version=_optional_text(payload.get("graph_version")),
        graph_ref=_optional_text(payload.get("graph_ref")),
        graph_checksum=_optional_text(payload.get("graph_checksum")),
