...
class DailyAgentToolService:
    """Business service behind Daily agent tools.

    The framework-facing ToolRegistry wires these methods as executors; this
    service keeps the actual evidence and citation operations independent from
    framework tool concerns.
    """
    ...
    def source_metadata(self, args: dict[str, Any]) -> dict[str, Any]:
        bundle = _evidence_bundle(args["evidence_bundle"])
        source_id = _optional_string(args.get("source_id"))
        source_url = _optional_string(args.get("source_url"))
        rows = []
    ...
    def validate_citations(self, args: dict[str, Any]) -> dict[str, Any]:
        report = args["report"]
    ...
    def build_section_draft(self, args: dict[str, Any]) -> dict[str, Any]:
        bundle = _evidence_bundle(args["evidence_bundle"])
