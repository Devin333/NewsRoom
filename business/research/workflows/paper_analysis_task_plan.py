...
RESEARCH_DYNAMIC_CAPABILITY_REGISTRY_REF = "research.task-plan-capabilities@1"
...
RESEARCH_DYNAMIC_GATES_BY_CAPABILITY = MappingProxyType(
    {
        ...
        "research.analysis.contribution": ("SummaryEvidenceCoverageGate@1",),
        "research.analysis.experiments": ("BenchmarkEvidenceLineageGate@1",),
    }
)
