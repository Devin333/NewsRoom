...
from business.research.domain.common import ensure_utc, non_negative_int, require_text
...
class CodeRepositoryObservation(PrimitiveModel):
    ...
    @field_validator("stars", "forks", "watchers")
    @classmethod
...
def compute_star_growth(
    ...
    delta_days = max((current.observed_at - previous.observed_at).total_seconds() / 86400.0, 1.0)
