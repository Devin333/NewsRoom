...
def authorized_release_fixture(*, release_version: str = "1.1.0") -> AuthorizedReleaseFixture:
    ...
    intent = HarnessSideEffectIntent(
        ...
        graph_id="skill.release.fixture",
        graph_version="1",
        graph_ref="skill.release.fixture@1",
        graph_checksum=checksum_for({"graph_id": "skill.release.fixture", "graph_version": "1"}),
        origin="worker",
        ...
        node_instance_id="node:skill-release-fixture",
        activity_id="activity:skill-release-fixture",
