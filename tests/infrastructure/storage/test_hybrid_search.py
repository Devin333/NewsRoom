...
from infrastructure.storage.hybrid_search import HybridSearchQuery, HybridSearchService
from infrastructure.storage.local_json import LocalJsonRepository
from infrastructure.storage.vector import InMemoryVectorStore, VectorDocument
...
def test_hybrid_search_merges_report_keyword_and_vector_results(tmp_path) -> None:
    ...
    assert section_result.refs["run_id"] == "run-1"
