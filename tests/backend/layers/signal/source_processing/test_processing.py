...
from backend.layers.signal.source_processing import (
...
from backend.layers.signal.source_processing.fallback import (
    SourceErrorFallbackInput,
    SourceItemFallbackInput,
    SourceSelectionFallbackInput,
)
from backend.layers.signal.source_processing.governance import SourceGovernancePolicy
from backend.foundation.primitives.source_ref import canonicalize_url
from backend.layers.signal.source_processing.normalize import normalize_text
