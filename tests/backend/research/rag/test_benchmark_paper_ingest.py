...
from backend.research.rag.evaluation.paper_benchmark_ingest import _build_parser, ingest_benchmark_papers
...
def test_ingest_benchmark_papers_merges_pdf_sidecar_visuals(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        "backend.research.rag.evaluation.paper_benchmark_ingest.merge_pdf_visual_sidecar",
        fake_merge,
    )
...
def test_ingest_benchmark_papers_passes_pdf_parser_backend(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        "backend.research.rag.evaluation.paper_benchmark_ingest.ArxivDocumentParser",
