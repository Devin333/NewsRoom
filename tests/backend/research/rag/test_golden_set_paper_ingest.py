...
from backend.research.rag.cli import ingest_golden_set_papers as ingest_cli
from backend.research.rag.evaluation import golden_set_paper_ingest
from backend.research.rag.evaluation.golden_set_paper_ingest import ingest_golden_set_papers
