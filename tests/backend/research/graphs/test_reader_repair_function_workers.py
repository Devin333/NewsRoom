...
from backend.research.graphs.reader_repair_execution_gates import (
...
def test_reader_repair_function_worker_module_stays_out_of_production_composition() -> None:
    module_source = Path(
        "backend/research/graphs/reader_repair_function_workers.py"
    ...
    production_sources = "\n".join(
        ...
        for path in (
            ...
            "backend/research/graphs/__init__.py",
        )
    )
