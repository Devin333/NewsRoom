...
from business.layers.relation.evidence import Claim, ClaimVerifier, EvidenceBundle, EvidenceItem
...
def test_claim_extractor_extracts_section_claims_from_report() -> None:
    from business.layers.relation.evidence import ClaimExtractor
