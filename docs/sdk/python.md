...
reach into Graph executors, AgentLoop workers, concrete stores, Harness
internals, or business runtime modules.
...
- `client.waits`: inspect Graph Waits, deliver bounded signals, submit approval decisions, and cancel a Wait. Harness retains Graph identity, authorization, routing, and automatic resume authority.
