...
- Waits and approvals: inspect Graph Wait causes, deliver bounded signals, and
  submit review decisions through API contracts. Harness owns authorization,
  routing, and automatic resume after durable commit.
