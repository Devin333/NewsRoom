...
Use `docs/api/openapi.json` as the generated endpoint contract. Graph Wait endpoints are also defined by `interfaces/api/openapi_graph_contract.json`; legacy board, paper, and workflow-resume API paths are intentionally absent.
